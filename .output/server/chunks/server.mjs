import { getCurrentInstance, toRef, isRef, inject, version, defineComponent, h, computed, unref, Suspense, nextTick, Transition, provide, reactive, ref, resolveComponent, shallowRef, isReadonly, createApp, effectScope, markRaw, watch, isReactive, toRaw, defineAsyncComponent, onErrorCaptured, onServerPrefetch, useSSRContext, getCurrentScope, onScopeDispose, withCtx, createVNode, toRefs } from 'vue';
...
const appHead = { "meta": [{ "charset": "utf-8" }, { "name": "viewport", "content": "width=device-width ,initial-scale=1.0" }, { "name": "description", "content": "welcome to My project" }, { "name": "keyword", "content": "HTML,CSS,Js developer" }, { "http-equiv": "X-UA-Compatible", "content": "ie=edge" }], "link": [], "style": [], "script": [], "noscript": [], "title": "my website", "bodyAttrs": {} };
...
const _routes = [
  {
    name: (__nuxt_page_meta$4 == null ? void 0 : __nuxt_page_meta$4.name) ?? "cart",
    path: (__nuxt_page_meta$4 == null ? void 0 : __nuxt_page_meta$4.path) ?? "/cart",
    children: [],
    meta: __nuxt_page_meta$4,
    alias: (__nuxt_page_meta$4 == null ? void 0 : __nuxt_page_meta$4.alias) || [],
    redirect: (__nuxt_page_meta$4 == null ? void 0 : __nuxt_page_meta$4.redirect) || void 0,
    component: () => import('./cart-a9501038.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./index-d2f9baf4.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./products-1153be00.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.name) ?? "tasks",
    path: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.path) ?? "/tasks",
    children: [
      {
        name: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.name) ?? "tasks-tasks",
        path: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.path) ?? ":tasks?",
        children: [],
        meta: __nuxt_page_meta,
        alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
        redirect: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect) || void 0,
        component: () => import('./_tasks_-ee387a87.mjs').then((m) => m.default || m)
      }
    ],
    meta: __nuxt_page_meta$1,
    alias: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.alias) || [],
    redirect: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.redirect) || void 0,
    component: () => import('./tasks-ded02e0b.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./default-9fb24d14.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./error-component-567dd411.mjs').then((r) => r.default || r));
    const IslandRendererer = defineAsyncComponent(() => import('./island-renderer-b181f9d0.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { __nuxt_component_0$2 as _, useRoute as a, useState as b, createError as c, defineStore as d, entry$1 as default, __nuxt_component_0 as e, navigateTo as n, useNuxtApp as u };
